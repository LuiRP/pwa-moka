		...
		<form action="{{ route('reserva.store') }}" method="POST" class="text-pink-600">
			...
			<div class="flex flex-col gap-2">
				...
				<div class="mt-3 flex flex-row items-center gap-1 space-x-2">
					...
					<input class="rounded border-2 border-pink-600 p-1" type="time" min="09:00" max="18:00" name="hora">
				</div>

				<div class="mt-3 flex flex-col gap-1">
					<input class="rounded-lg border-2 border-pink-600" type="number" placeholder="Número de Personas" step="1"
						min="0" name="numero_personas" value="{{ old('numero_personas') }}" required>
				</div>
